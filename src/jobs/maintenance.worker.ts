...
// Repeatable daily maintenance. Currently just the low-stock digest. The
// repeatable schedule is (re)registered at worker startup — BullMQ dedupes on
// the repeat key, so restarts don't stack duplicates.
